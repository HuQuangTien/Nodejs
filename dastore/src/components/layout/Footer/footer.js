        ...
        <Footer style={{ backgroundColor: "#1e0a3c", padding: 30, paddingTop: 80 }}>
            <Row className="footer-desktop">
                ...
                <Col span={5} className="footer">
                    ...
                    <p style={{ marginTop: 20, color: "#FFFFFF", fontWeight: 400, fontSize: 14, cursor: "pointer" }}>Chi nhánh 1: 475A Đ. Điện Biên Phủ, <br /> Phường 25, Bình Thạnh, Thành phố Hồ Chí Minh</p>
                    <p style={{ marginTop: 20, color: "#FFFFFF", fontWeight: 400, fontSize: 14, cursor: "pointer" }}>Chi nhánh 2: VQ4P+249, Phường Tân Phú, Quận 9, Thành phố Hồ Chí Minh</p>
            ...
            <div className="footer-mobile">
                ...
                <Row justify="center">
                    <p style={{ marginTop: 20, color: "#FFFFFF", fontWeight: 400, fontSize: 14, cursor: "pointer" }}>Mobile Store</p></Row>
                <Row justify="center">
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: "#FFFFFF", fontSize: 13 }}>Copyright@ 2024 Created by team DaStore</p>
                <p style={{ color: "#FFFFFF", fontSize: 13 }}>Điện thoại: (+84) 000.0000000 - (+84) 111.111111</p>
            </div>
        </Footer>
    );
}
